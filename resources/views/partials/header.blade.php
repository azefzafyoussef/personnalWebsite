        ...
        <div class="flex justify-between items-center py-4">
            ...
            <div class="flex items-center space-x-3">
                <a href="{{ route('home') }}" class="flex items-center space-x-3">
                    <img src="/logo4.png" alt="Logo" class="h-8 w-auto object-contain"
                        style="position: relative; left: 2rem; scale:1.3">
            ...
            <nav class="hidden md:flex space-x-8">
                <a href="{{ route('home') }}"
                   ...
                   {{ request()->routeIs('home') ? 'text-blue-400 border-b-2 border-blue-400 pb-1' : '' }}">
                    Home
                </a>
...
<div class="flex items-center space-x-1 mr-2" x-data="{ open: false }" @click.outside="open = false">
    ...
    <div x-show="open"
         x-transition
         class="absolute right-4 mt-12 w-28 bg-gray-800 border border-gray-700 rounded-lg shadow-lg py-1 z-50">
