        ...
        <div class="bg-white rounded-lg shadow p-6">
            <form action="{{ route('admin.posts.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="space-y-6">
                    ...
                    <!-- ZIP File Upload -->
                    <div>
                        <label for="file_path" class="block text-sm font-medium text-gray-700">Upload ZIP File</label>
                        <input type="file" name="file_path" id="zip_file" accept=".zip"
                            class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring-blue-500 focus:border-blue-500">
                        <p class="mt-1 text-sm text-gray-500">Upload a ZIP file (Max: 10MB)</p>
                        @error('file_path')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                        ...
                        @if (old('zip_filename'))
                            <div class="mt-2 p-2 bg-green-50 rounded-md">
                                <p class="text-sm text-green-700">Previously uploaded: {{ old('zip_filename') }}</p>
                            </div>
                        @endif
                    </div>
