...
<head>
    ...
    <title>@yield('title', 'Admin - NotesHub')</title>
        ...
        <div class="w-64 bg-blue-800 text-white">
            <div class="p-4">
                <div class="flex items-center space-x-3 mb-8">
                    ...
                    <span class="text-xl font-bold">NotesHub Admin</span>
                </div>
                ...
                <nav class="space-y-2">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit" class="flex items-center space-x-3 p-3 rounded-lg hover:bg-blue-700 w-full text-left">
